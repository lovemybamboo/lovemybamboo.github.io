    ...
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        if (next && next.value === tile.value && !next.mergedFrom) {
          var newValue='';
          switch (tile.value){
            case '哆':newValue='瑞';break;
            case '瑞':newValue='咪';break;
            case '咪':newValue='法';break;
            case '法':newValue='索';break;
          ...
          var newValue=0;
          switch (merged.value){
            case '哆':newValue=2;break;
            case '瑞':newValue=4;break;
            case '咪':newValue=8;break;
            case '法':newValue=16;break;
            case '索':newValue=32;break;
