...
function selfAdaption() {
    ...
    for (i = 1; i < 6; i++) {
        id = "#client-" + i;
        $(id).attr("src", "image/vision/logo/client-" + i + ".png");
    }
    ...
    for (i = 1; i < 9; i++) {
        id = "#img-" + i;
        $(id).css("background-image", "url(image/vision/case/" + i + "-dark.png)");
    }
...
function imageFunction() {
    ...
    $(".show-img").mouseover(function () {
        var id = $(this).attr("id");
        id = id.substring(4);
        imagePath = "image/vision/case/" + id + "-light.png"
        $("#img-" + id).css("background-image", "url(image/vision/case/" + id + "-light.png)");
    ...
    $(".show-img").mouseleave(function () {
        var id = $(this).attr("id");
        id = id.substring(4);
        imagePath = "image/vision/case/" + id + "-dark.png"
        $("#img-" + id).css("background-image", "url(image/vision/case/" + id + "-dark.png)");
...
function clickLeft(imgNumber) {
    $("#control-left").click(function () {
        ...
        for (var i = 1; i < 6; i++) {
            ...
            $(item).fadeIn("fast");
            $(item).attr("src", "image/vision/logo/client-" + img_id + ".png");
            $(item).show();
...
function clickRight(imgNumber) {
    $("#control-right").mouseover(function () {
        ...
        $("#control-right").css("background-color", "#ad043c");
    });
    $("#control-right").mouseleave(function () {
        $("#control-left").css("background-color", "#ad043c");
